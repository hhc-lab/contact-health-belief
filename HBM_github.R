...
library(tidyverse)
#############Load data#############
setwd("C:/Users/HHC-DT14/SynologyDrive/吳玫萱/發表/4. Proceedings B/Github")
...
par<- Cross[Cross$Time=="zpeak",c(1:3)]
...
contactagedata<- Cross[Cross$Time=="zpeak",c(1,29:40)]
...
par2<- Cross[Cross$Time=="trough",c(1:3)]
...
contactagedata2<- Cross[Cross$Time=="trough",c(1,29:40)]
